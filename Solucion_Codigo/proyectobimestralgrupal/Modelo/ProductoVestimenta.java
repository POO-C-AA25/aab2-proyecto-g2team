...
public class ProductoVestimenta extends Producto {
    public static ArrayList<ProductoVestimenta> productosVestimenta = new ArrayList<>();
    ...
    public boolean estaEnPromocion() {
        // Ejemplo de regla: promoción si stock > 40 o caduca este año
        return stock > 40 || anioCaduca <= java.time.LocalDate.now().getYear();
    }

    @Override
    public double obtenerPrecioLiquidado() {
        return estaEnPromocion() ? precioNormal * 0.7 : precioNormal;
    }
}